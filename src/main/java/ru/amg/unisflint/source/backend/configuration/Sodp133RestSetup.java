...
public class Sodp133RestSetup {

    Logger logger = LoggerFactory.getLogger(Sodp133RestSetup.class);


    @BeforeClass(alwaysRun = true)
    public void setUp () {
        RestAssured.baseURI = System.getProperty("RestAssured.baseUrl","http://10.100.20.133/");
