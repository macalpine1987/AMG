...
public class TestSetup7stand {

    Logger logger = LoggerFactory.getLogger(TestSetup7stand.class);

    @BeforeClass (alwaysRun = true)
    public void setupLaunchStand() {
        Configuration.baseUrl = System.getProperty("selenide.baseUrl", "http://10.100.20.7");
