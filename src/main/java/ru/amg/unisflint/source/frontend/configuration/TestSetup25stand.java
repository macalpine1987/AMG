...
public class TestSetup25stand {

    Logger logger = LoggerFactory.getLogger(TestSetup25stand.class);

    @BeforeClass(alwaysRun = true)
    public void setupLaunchStand() {
        Configuration.baseUrl = System.getProperty("selenide.baseUrl", "http://10.100.20.25");
