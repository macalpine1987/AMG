...
public class TestSetup133stand {

    Logger logger = LoggerFactory.getLogger(TestSetup133stand.class);

    @BeforeClass (alwaysRun = true)
    public void setupLaunchStand() {
        Configuration.baseUrl = System.getProperty("selenide.baseUrl", "http://10.100.20.133");
